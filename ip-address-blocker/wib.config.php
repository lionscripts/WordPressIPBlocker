...
define('WIB_BASIC_FULL_NAME_2', 'IP Blocker');
...
define('WIB_BASIC_FULL_NAME_PRO', WIB_BASIC_FULL_NAME_2 . ' Pro');
define('WIB_BASIC_FULL_NAME_HEADING', 'LionScripts: '.WIB_BASIC_FULL_NAME_2.' Lite');
...
define('WIB_BASIC_DB_VERSION', '2.0');
