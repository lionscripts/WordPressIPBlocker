...
$LIONSCRIPTS['ABOUT_US'][$objLionTemp->plg_hook_version] = '<p>
																<a href="'.LIONSCRIPTS_HOME_PAGE_URL.'?utm_source=lionscripts-dashboard-wibl-wp-pl" target="_blank"><img src="'.$objLionTemp->plg_images['www'].'logo.png" class="left ls_logo_about" /></a>
															...
															<p>
																<ul class="socialicons color">
																	<li><a href="'.LIONSCRIPTS_FACEBOOK_LINK.'?utm_source=lionscripts-dashboard-wibl-wp-pl" target="_blank" class="facebook"></a></li>
																	<li><a href="'.LIONSCRIPTS_TWITTER_LINK.'?utm_source=lionscripts-dashboard-wibl-wp-pl" target="_blank" class="twitter"></a></li>
																	<li><a href="'.LIONSCRIPTS_GOOGLE_PLUS_LINK.'?utm_source=lionscripts-dashboard-wibl-wp-pl" target="_blank" class="gplusdark"></a></li>
																	<li><a href="'.LIONSCRIPTS_YOUTUBE_LINK.'?utm_source=lionscripts-dashboard-wibl-wp-pl" target="_blank" class="youtube"></a></li>
